...
import {
  useReportExploreActions,
  COMPETITOR_MAX,
} from "./use-report-explore-actions";
...
function ExploreSection({
  ...
  // Lógica de período/concorrente partilhada — ver
  // `use-report-explore-actions.ts`. Comportamento inalterado.
  const {
    balance,
    intent,
    dialogOpen,
