        ...
        <div className="grid gap-3 md:grid-cols-2">
          {pending.map((s) => (
            <AdminCard key={s.id} variant="accent-left" accent="signal">
              ...
              <pre className="mb-3 rounded border border-admin-border bg-admin-bg-hover p-2 text-[12px] font-mono text-admin-text-secondary overflow-x-auto whitespace-pre-wrap">
