...
function Side({
  ...
  return (
    ...
    >
      ...
      <span
        className="tabular-nums font-semibold text-content-primary leading-[1.05] min-w-0 overflow-hidden whitespace-nowrap sm:whitespace-normal text-balance text-2xl sm:text-3xl md:text-4xl"
