...
export interface SnapshotPayload {
  ...
  /**
   * Visual cover analysis generated by OpenAI vision. Persisted alongside
   * the snapshot so subsequent renders skip the AI call.
   */
  visual_cover_analysis?: unknown;
  /**
   * Caption semantic analysis generated by OpenAI. Persisted alongside
   * the snapshot so subsequent renders skip the AI call.
   */
  caption_semantic_analysis?: unknown;
}
